...
class Engine : public CarPart {
    protected:
        ...
        int Revamount;
        public:
            Engine(Mediator *med) : CarPart(med), RPM(0), Revamount(0) {}
            void Start();
...
class Electric : public CarPart {
    protected:
        ...
        int ChangedBy;
    public:
        Electric(Mediator *med) : CarPart(med), Output(0), ChangedBy(0) {}
...
class Airconditioner : public CarPart {
    protected:
        ...
        int ChangedBy;
    public:
        Airconditioner(Mediator *med) : CarPart(med),Level(0), ChangedBy(0) {}
        void TurnOn();
        void TurnOff();
